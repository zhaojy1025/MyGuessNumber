...
public class GuessNumberTest {
    ...
    @Test
    public void should_return_1a3b_given_partial_digits_are_correct(){
        GuessNumber guessNumber = new GuessNumber("1234");
        String result = guessNumber.validate("1423");
        assertEquals("1a3b",result );
    }

    @Test
    public void should_return_0a4b_given_partial_digits_are_correct(){
        GuessNumber guessNumber = new GuessNumber("1234");
